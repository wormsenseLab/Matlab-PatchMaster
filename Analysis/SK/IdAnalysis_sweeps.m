...
% NEXT:              
            ...
            % Insert column 3 into theseStim so findMRCs_sweeps has access
            % to the sorting parameter.
            
            theseStim = [theseStim(:,1:2) repmat(eachStimProfile(iProfile,iStim),size(theseStim,1),1) theseStim(:,3:end)];
