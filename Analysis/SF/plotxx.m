...
ax(2) = axes('Position',ax1_pos,...
    'XAxisLocation','top',...
    'YAxisLocation','right',...
    'Color','none');
%set(ax(1),'Position',[0.12 0.12 0.75 0.70])
% set(ax1,'Position')%,[0.12 0.12 0.75 0.70])
...
hl2=line(x2,y2,'Color','w','Parent',ax(2)); % plot white. could not figure out how to do it with scatter
hold on
scatter(x2,y2,'k')
ylim([-5 20])
%hl2=scatter(x2,y2,'Parent',ax(2));
%hl2=line(x2,y2,'Parent',ax(2),'Color','k')
%hl2=scatter(x2,y2,ax(2));
